...
class WKProvisionalPage {
  constructor(session, page) {
    ...
    this.initializationPromise = this._wkPage._initializeSession(session, true, ({ frameTrie }) => this._handleFrameTrie(frameTrie));
  }
  ...
  _handleFrameTrie(frameTrie) {
    (0, import_utils.assert)(!frameTrie.frame.parentId);
    this._mainFrameId = frameTrie.frame.id;
  }
}
