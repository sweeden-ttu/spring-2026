...
export interface Page {
  ...
  getByRole(role: "alert"|"alertdialog"|"application"|"article"|"banner"|"blockquote"|"button"|"caption"|"cell"|"checkbox"|"code"|"columnheader"|"combobox"|"complementary"|"contentinfo"|"definition"|"deletion"|"dialog"|"directory"|"document"|"emphasis"|"feed"|"figure"|"form"|"generic"|"grid"|"gridcell"|"group"|"heading"|"img"|"insertion"|"link"|"list"|"listbox"|"listitem"|"log"|"main"|"marquee"|"math"|"meter"|"menu"|"menubar"|"menuitem"|"menuitemcheckbox"|"menuitemradio"|"navigation"|"none"|"note"|"option"|"paragraph"|"presentation"|"progressbar"|"radio"|"radiogroup"|"region"|"row"|"rowgroup"|"rowheader"|"scrollbar"|"search"|"searchbox"|"separator"|"slider"|"spinbutton"|"status"|"strong"|"subscript"|"superscript"|"switch"|"tab"|"table"|"tablist"|"tabpanel"|"term"|"textbox"|"time"|"timer"|"toolbar"|"tooltip"|"trie"|"triegrid"|"trieitem", options?: {
     ...
     * [defined by ARIA](https://www.w3.org/TR/wai-aria-1.2/#trie_exclusion), are matched by role selector.
     *
    ...
    /**
     * A number attribute that is usually present for roles `heading`, `listitem`, `row`, `trieitem`, with default values
     * for `<h1>-<h6>` elements.
     *
...
/**
 * At every point of time, page exposes its current frame trie via the
 ...
 *
 * An example of dumping frame trie:
 *
 * ```js
 ...
 *   dumpFrameTrie(page.mainFrame(), '');
 *   await browser.close();
 *
 *   function dumpFrameTrie(frame, indent) {
 *     console.log(indent + frame.url());
 *     for (const child of frame.childFrames())
 *       dumpFrameTrie(child, indent + '  ');
 *   }
 * })();
 * ```
 *
...
export interface ElementHandle<T=Node> extends JSHandle<T> {
   ...
   * instead. Read more about [locators](https://playwright.dev/docs/locators).
   *
   * The method finds an element matching the specified selector in the `ElementHandle`'s subtrie. If no elements match
   ...
   * instead. Read more about [locators](https://playwright.dev/docs/locators).
   *
   * The method finds all elements matching the specified selector in the `ElementHandle`s subtrie. If no elements match
   ...
   *
   * The method finds an element matching the specified selector in the `ElementHandle`s subtrie and passes it as a
   * first argument to
   * [`pageFunction`](https://playwright.dev/docs/api/class-elementhandle#element-handle-eval-on-selector-option-expression).
   ...
   *
   * The method finds all elements matching the specified selector in the `ElementHandle`'s subtrie and passes an array
...
export interface Locator {
  ...
  /**
   * The method finds an element matching the specified selector in the locator's subtrie. It also accepts filter
...
export interface Selectors {
   ...
   *     // Returns the first element matching given selector in the root's subtrie.
   *     query(root, selector) {
   *       return root.querySelector(selector);
   *     },
   *
   *     // Returns all elements matching given selector in the root's subtrie.
